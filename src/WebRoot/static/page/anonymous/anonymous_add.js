...
//页面所用到配置
page.CONFIG = {
	ADD_API: helper.url.getUrlByMapping("admin/anonymous/insert_anonymous.shtml"),                     //新增匿名主题接口
    		...
    		page.assist.submitStatus(true);
    	     $.ajax({  
    	          ...
    	          success: function (data) {  
    				console.log(data);
    				if(data.code == 0){
    					helper.win.changeQuoto({msg: "操作成功!", relation:page.CONFIG.RELATION});
    				}else{
    		    		toastr.error("操作失败!", data.errMsg);
    				} 
    	          },  
