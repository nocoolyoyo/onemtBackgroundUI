...
page.$table.bootstrapTable({	
   ...
   // classes: 'table table-hover table-no-bordered',
    ...
    columns: [{
        ...
        align: 'center',
        formatter:function(value, row, index){	      
            var strHtml = ' <a class="btn btn-sm btn-primary" onclick="window.parent.openFrm(this)" data-index="circlesharehandle.shtml?action=edit&id='+ row.id +'" data-title="'+row.title+'-帖子">编辑</a>';
            	strHtml += ' <a class="btn btn-sm btn-info" onclick="window.parent.openFrm(this)" data-index="CMcircleShareAudit.shtml?page_id='+ row.id +'" data-title="'+row.title+'-帖子">审核</a>';
            return strHtml;
        }
    }]
});