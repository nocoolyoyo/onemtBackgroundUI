...
page.$table.bootstrapTable({	
   ...
   // classes: 'table table-hover table-no-bordered',
    ...
    columns: [{
        ...
        align: 'center',
        formatter:function(value, row, index){	
            var strHtml =  ' <a class="btn btn-sm btn-primary" onclick="window.parent.openFrm(this)" data-index="CMcircleTopicEdit.shtml?page_id='+ row.id +'" data-title="'+row.title+'-编辑">编辑</a>';
    			strHtml += ' <button class="btn btn-sm btn-outline btn-default" onclick="window.parent.openFrm(this)" data-index="CMcircleTopicOpinionsAll.shtml?page_id='+ row.id +'" data-title="'+row.title+'-编辑">观点管理</button>';
