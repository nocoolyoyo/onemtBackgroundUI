...
//页面静态变量
page.CONST = {
    GET_LIST: helper.url.getUrlByMapping("admin/topic/find_topic.shtml"),      //获取全部帮助接口
...
page.$table.bootstrapTable({	
   ...
   // classes: 'table table-hover table-no-bordered',
    ...
    columns: [{
        ...
        align: 'center',
        formatter:function(value, row, index){	      
            var strHtml = ' <a class="btn btn-sm btn-primary" onclick="window.parent.openFrm(this)" data-index="CMcircleTopicEdit.shtml?page_id='+ row.id +'" data-title="'+row.title+'-话题">编辑</a>';
            	strHtml += ' <a class="btn btn-sm btn-info" onclick="window.parent.openFrm(this)" data-index="CMcircleTopicAudit.shtml?page_id='+ row.id +'" data-title="'+row.title+'-话题">审核</a>';
            	strHtml += ' <div class="del btn btn-sm btn-danger">删除</div>';
            	return strHtml;
        },
        events: {
	          //删除
