...
page.$table = $('#tableList');
	page.$createStartTime = $('#startTime');//圈子关键字
...
page.derive = {
    ...
    getParams: function (params) {
        ...
        if(page.$createStartTime.val()!=="")params.create_Start_time =page.$createStartTime.val();//搜索值
...
page.$table.bootstrapTable({	
   ...
   // classes: 'table table-hover table-no-bordered',
    ...
    columns: [{
        ...
        align: 'center',
        formatter:function(value, row, index){	      
            var strHtml = ' <a class="btn btn-sm btn-primary" onclick="window.parent.openFrm(this)" data-index="CMcircleShareEdit.shtml?page_id='+ row.id +'" data-title="'+row.title+'-话题">编辑</a>';
            	strHtml += ' <a class="btn btn-sm btn-info" onclick="window.parent.openFrm(this)" data-index="CMcircleShareAudit.shtml?page_id='+ row.id +'" data-title="'+row.title+'-话题">审核</a>';
            return strHtml;
        }
    }]
});