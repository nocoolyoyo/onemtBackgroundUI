...
//页面所用到AJAX请求的URL
page.CONFIG = {
    GET_LIST: helper.url.getUrlByMapping("admin/shanghui/find_notice.shtml?NOTICESTATUS=1"),     //查询待审核设备推送接口
    ...
    REWRITE_API: helper.url.getUrlByMapping("admin/shanghui/update_shanghuinotice_common.shtml"), 
...
//            width: "150px",
        ...
        },
        {
            ...
            width: "250px",
            formatter:function(value, row){
                var strHtml=' <button type="button" class="btn btn-sm btn-danger" onclick="page.eventHandler.delete(' + row.NID + ')">删除</button>';
                return strHtml;
            }
        }]
    });
