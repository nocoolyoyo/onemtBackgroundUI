...
//页面所用到AJAX请求的URL
page.CONFIG = {
    GET_LIST: helper.url.getUrlByMapping("admin/shanghui/find_information.shtml?SAVETYPE=2"),     //查询待审核设备推送接口
...
//            width: "150px",
        ...
        },
        {
            ...
            width: "200px",
            formatter:function(value, row){
                var strHtml=' <button type="button" class="btn btn-sm btn-danger" onclick="page.eventHandler.delete(' + row.INID + ')">恢复</button>';
                return strHtml;
            }
        }]
    });
