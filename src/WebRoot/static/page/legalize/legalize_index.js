...
page.eventHandler = {	
	showAdd: function () {
		helper.win.open({name: "新增认证方式",url: "legalize/addlegalize.shtml"});
	},
	showUpdata: function (id) {
		helper.win.open({name: "编辑认证方式",url: "legalize/editlegalize.shtml?id="+id});
	},
	delete: function (id) {
	    swal({
	        title: "您确定要删除选中的信息吗？",
...
$table.bootstrapTable({
    //请求相关
    url: helper.url.getUrlByMapping('admin/legalize/find_legalizelists.shtml'),  //AJAX读取列表数据的URL
    method: "get",                  //请求方式
