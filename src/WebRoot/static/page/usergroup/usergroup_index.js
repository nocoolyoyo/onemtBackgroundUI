...
page.eventHandler = {
	showAdd: function () {
		helper.win.open({name: "新增用户组",url: "usergroupadd.shtml"});
	},
	showUpdata: function (id) {
		helper.win.open({name: "编辑用户组",url: "usergroupedit.shtml?id="+id});
	},
	delete: function (id) {
	    swal({
	        title: "您确定要删除选中的信息吗？",
    		...
    		$.ajax({
	    		url: 'usergroup/delete_usergroup.shtml',
	    		data: {
	    			id: id
	    		},
	    		type: 'post',
...
$table.bootstrapTable({
    //请求相关
    url: helper.url.getUrlByMapping('admin/usergroup/find_usergrouplists.shtml'),  //AJAX读取列表数据的URL
    method: "get",                  //请求方式
