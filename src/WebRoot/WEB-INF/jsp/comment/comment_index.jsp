...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated fadeInRight dashboard-header">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <!--  <h3 style="display:inline-block">评论管理 ><span id="commentTitle" style="display:none"><span class="label-warning"></span>></span>全部评论</h3>-->
                <h3>评论管理&nbsp;&nbsp;&nbsp;<span id="commentTitle" style="display:none"><span class="label-warning"></span>&nbsp;&nbsp;&nbsp;</span><small id="pageSubTitle">全部评论</small></h3>
            </div>
    ...
    <%--页面css及js文件--%>
    <script src="<%=basePath%>static/page/comment/comment_index.js?v=<%=StaticVersion%>"></script>
</body>
</html>
