...
<body class="gray-bg">
                ...
                <div id="tableTools">
                    <form class="form-inline bars">
                        <div class="input-group m-b-xs">
                            <input id="SHNAME" type="text" size="10" class="form-control" placeholder="请输入商会名称" />
                        </div>
                        ...
                        <div class="input-group date m-b-xs">
                            <input id="updateStartTime" class="form-control form_date" size="10" type="text" value="" placeholder="删除日期-起" readonly />
                            <label for="startTime" class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></label>
                        </div>
                        <div class="input-group date m-b-xs">
                            <input id="updateEndTime" class="form-control form_date" size="10" type="text" value="" placeholder="删除日期-止" readonly />
                            <label for="endTime" class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></label>
                        </div>
                        <div class="input-group m-b-xs">
                            <input id="TITLE" type="text" size="10" class="form-control" placeholder="请输入标题" />
                        </div>
    ...
    <script src="<%=basePath%>static/page/shanghui/shanghui_dustbin.js"></script>
</body>
</html>
