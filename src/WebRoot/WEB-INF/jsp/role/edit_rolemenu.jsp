	        ...
	        <form id="frmAddCiphertext" class="form-horizontal" action="javascript:;">
                ...
                <div class="form-group">
			      ...
			      <div id="divAction" class="row m-t-lg text-center">
				      <button id="save_btns" onclick="page.eventHandler.getselectmenus()" type="button" class="btn btn-lg btn-info dim m-l"><i class="glyphicon glyphicon-floppy-open"></i>&nbsp;&nbsp;保&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;存</button>
