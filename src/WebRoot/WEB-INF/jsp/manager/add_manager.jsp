	        ...
	        <form id="frmAddCiphertext" class="form-horizontal">
                ...
                <div class="form-group">
			      ...
			      <div id="divAction" class="row m-t-lg text-center">
				      <button id="preservation_user" type="button" disabled="disabled" class="btn btn-lg btn-info dim m-l"><i class="glyphicon glyphicon-floppy-open"></i>&nbsp;&nbsp;保存用户</button>
            		...
            		$.ajax({
            			...
            			success: function(res){
            				...
            				if(res.code == 0){
                                ...
                                toastr.error('用户添加失败！', res.errMsg);
            				}
            			},
            			error: function(xhr){
            				console.log(xhr);
