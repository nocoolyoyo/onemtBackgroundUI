    ...
    <div class="wrapper wrapper-content animated fadeInRight dashboard-header">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h3>内容审核&nbsp;&nbsp;&nbsp;<small id="pageSubTitle">垃圾箱</small></h3>
            </div>
            <div class="ibox-content ">
                <div id="tableTools">
                    <form class="form-inline bars">
                        ...
                        <div class="input-group date m-b-xs">
                            <input id="startTime1" class="form-control form_date" size="10" type="text" value="" placeholder="删除日期-起" readonly />
                            <label for="start_time1" class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></label>
                        </div>
                        <div class="input-group date m-b-xs">
                            <input id="endTime1" class="form-control form_date" size="10" type="text" value="" placeholder="删除日期-止" readonly />
                            <label for="end_time1" class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></label>
                        </div>
...
<%--     <!--日期控件-->
    ...
    <script src="<%=basePath%>static/page/association/association_delete.js"></script>
</body>
</html>