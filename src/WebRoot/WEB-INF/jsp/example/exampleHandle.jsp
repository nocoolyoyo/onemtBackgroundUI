...
<body class="gray-bg">
    <div class="wrapper wrapper-content animated">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h3>榜样管理&nbsp;&nbsp;&nbsp;<small id="pageSubTitle">新增/修改榜样</small></h3>
            </div>
            <div class="ibox-content">
                <form id="frmAddExample" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="hidden" id="fileSelectorSrc" name="fileSrc">
                            <small id="filePrompt" class="help-block" style="display:none" data-bv-validator="notEmpty" data-bv-for="file" data-bv-result="INVALID" style="">封面必须上传</small>
                        </div>
                    </div>           
                    <div class="form-group">
                    ...
                    <!--<div class="form-group" id="selectExampleUser">
                        <label class="col-sm-2 control-label">榜样人物：</label>
                        <div class="col-sm-9">
                            <span class="btn btn-info" id="select_user">选择榜样人物</span>
                            <a href="javascript:;" id="user_info"></a>
                            <div id="exampleUserPrompt" style="display:none;color:#a94442"></div>
                        </div>
                    </div>  -->
                    <div class="row" id="selectExampleUserCon">
                        <label class="col-sm-2 control-label">榜样人物：</label>
                        <div class="col-sm-9" id="selectExampleUser">
    ...
    <%--页面css及js文件--%>
    <script src="<%=basePath%>static/page/example/exampleHandle.js?v=<%=StaticVersion%>"></script>
</body>
</html>
