  ...
  <body>
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
             <h3>用户组管理&nbsp;&nbsp;&nbsp;<small id="pageSubTitle">新增用户组</small></h3>
        </div>
	        ...
	        <form id="frmAddCiphertext" class="form-horizontal" action="javascript:;">
                ...
                <div class="form-group">
			      ...
			      <div id="divAction" class="row m-t-lg text-center">
				      <button id="add_user" type="button" disabled="disabled" class="btn btn-lg btn-info dim m-l"><i class="glyphicon glyphicon-floppy-open"></i>&nbsp;&nbsp;保存用户组</button>
        ...
        $(document).ready(function(){
        	...
        	$("#add_user").on('click',function(){
                ...
                if(bv.isValid()){
            		...
            		$.ajax({
            			url: '<%=basePath%>admin/usergroup/insert_usergroup.shtml',
            			data: {
            			...
            			success: function(res){
            				console.log(res);
            				if(res.code == 0){
            					//swal({title: "用户组添加成功",type: "success"});
