  ...
  <body>
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
             <h3>用户权重管理&nbsp;&nbsp;&nbsp;<small id="pageSubTitle">编辑用户权重</small></h3>
        </div>
			...
			//获取修改记录信息
			 $.ajax({
		         ...
		         success:function(res){
		       	  	if(res.code == 0){
			       	  	$('#id').val(res.data.id);
			            $('#weightsname').val(res.data.weightsname);
			            $('#weightsnum').val(res.data.weightsnum);
        ...
        $(document).ready(function(){
        	...
        	$("#add_user").on('click',function(){
                ...
                if(bv.isValid()){
            		...
            		$.ajax({
            			url: '<%=basePath%>admin/weights/update_weights.shtml',
            			data: {
            				id: $("#id").val(),
            			...
            			success: function(res){
            				console.log(res);
            				if(res.code == 0){
            				//	swal({title: "用户权重信息修改成功",type: "success"});
