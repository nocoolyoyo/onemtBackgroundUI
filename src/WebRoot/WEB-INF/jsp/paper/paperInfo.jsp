...
<body class="gray-bg">
        ...
        <div class="ibox float-e-margins">
            <div class="ibox-content col-md-offset-1 col-md-10">
                <div id="divLabelPanel" class="pull-left">
                    <span id="lblState" data-tip="早茶发布到信息流中的状态" class="label label-inverse">发布状态加载中...</span>
                    <span id="lblStatus" data-tip="已删除的早茶将进入垃圾箱" class="label label-inverse">垃圾箱状态加载中...</span>
                    <span id="lblPaperDate" data-tip="早茶日期" class="label label-inverse">早茶日期状态加载中...</span>
                </div>
    ...
    <%--页面css及js文件--%>
    <script src="<%=basePath%>static/page/paper/paperInfo.js?v=<%=StaticVersion%>"></script>
</body>
</html>