...
<html lang="zh_cn">
	...
	<body class="gray-bg" style="background:#fff;padding-top:20px">
       <form id="addshangjiForm" class="form-horizontal" novalidate="novalidate">
        	<div class="modal-body" id="shangjiForm">
		...
		<script src="<%=basePath%>js/shangji/shangji_edit.js"></script>
  	</body>
</html>
