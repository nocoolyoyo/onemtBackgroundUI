      		 ...
      		 <div class="col-sm-2">
                <div class="ibox float-e-margins">
	             		...
	             		<div class="ibox-content">
							...
							<a class="btn btn-block btn-primary" href="circleCMDeletedComments.shtml?circle_id=${paramMap.circle_id}">已删除评论</a>
						</div>
                </div>
            </div>
	            ...
	            <div class="col-sm-10">
	                <div class="ibox float-e-margins">
	                    <div class="ibox-title">
	                        <h3>内容管理&nbsp;&nbsp;&nbsp;<small id="pageSubTitle">已删除评论列表</small></h3> 
	                    </div>
						<div class="ibox-content">
						    <div id="tableTools">
...
<%-- 	<!--日期控件-->
	...
	<script src="<%=basePath%>static/page/circles/circleCMDeletedComments.js?v=<%=StaticVersion%>"></script>
</html>
