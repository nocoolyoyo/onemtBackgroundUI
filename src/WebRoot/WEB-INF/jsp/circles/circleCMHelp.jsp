      		...
      		<div class="col-sm-2">
                <div class="ibox float-e-margins">
	             		...
	             		<div class="ibox-content">
							...
							<a class="btn btn-block btn-primary">帮助</a>
	            ...
	            <div class="col-sm-10">
	                <div class="ibox float-e-margins">
	                    <div class="ibox-title">
	                        <h3>内容管理&nbsp;&nbsp;&nbsp;<small id="pageSubTitle">帮助列表</small></h3>  
	                    </div>
	             		<div class="ibox-content">
						    <div id="tableTools">
...
<%--     <link href="<%=basePath%>static/lib/datetimepicker/bootstrap-datetimepicker.min.css" rel="stylesheet" />
	...
	<script src="<%=basePath%>static/page/circles/circleCMHelp.js?v=<%=StaticVersion%>"></script>
</html>
