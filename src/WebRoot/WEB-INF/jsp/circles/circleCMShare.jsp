...
<html lang="zh_cn">
  ...
  <body class="gray-bg">
     <div style="display:none" id="params_id" data-value="${paramMap.circle_id}"></div>
      		...
      		<div class="col-sm-2">
                <div class="ibox float-e-margins">
	             		...
	             		<div class="ibox-content">
							...
							<a class="btn btn-block btn-primary">帖子</a>
	            ...
	            <div class="col-sm-10">
	                <div class="ibox float-e-margins">
	                    <div class="ibox-title">
	                        <h3>内容管理&nbsp;&nbsp;&nbsp;<small id="pageSubTitle">帖子列表</small></h3>  
	                    </div>
	             		<div class="ibox-content">
							<div id="tableTools">
...
<%--     <link href="<%=basePath%>static/lib/datetimepicker/bootstrap-datetimepicker.min.css" rel="stylesheet" />
	...
	<script src="<%=basePath%>static/page/circles/circleCMShare.js?v=<%=StaticVersion%>"></script>
</html>
