...
<div class="wrapper wrapper-content animated fadeInRight dashboard-header">
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h3>圈子管理&nbsp;&nbsp;&nbsp;<small id="pageSubTitle">圈子垃圾箱</small></h3>
        </div>
            ...
            <div id="tableTools">
                ...
                <form class="form-inline bars">
                    <div class="input-group date m-b-xs">
                        <input id="startTime" class="form-control form_date" size="10" type="text" data-end="#releaseEndTime" value="" placeholder="删除日期-起" readonly />
                        <label for="startTime" class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></label>
                    </div>
                    <div class="input-group date m-b-xs">
                        <input id="endTime" class="form-control form_date" size="10" type="text" data-start="#releaseStartTime" value="" placeholder="删除日期-止" readonly />
...
<%--     <!--日期控件-->
    ...
    <%--页面css及js文件--%>
    <script src="<%=basePath%>static/page/circles/circlesTrash.js?v=<%=StaticVersion%>"></script>
</body>
</html>
