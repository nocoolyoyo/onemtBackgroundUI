        ...
        <form id="frmAddUser" class="form-horizontal">
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    <input id="headImageUrl" type="hidden" />
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input class="form-control" readonly="readonly" id="mobile" type="text" name="mobile" placeholder="请输入手机号">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="row m-t-lg text-center" id="divAction">
                <div class="col-md-offset-3 col-md-3" id="preservation_user"><button type="button" disabled="disabled" class="btn btn-primary btn-block btn-lg"><i class="fa fa-check-circle"></i>&nbsp;&nbsp;确定修改</button></div>
                <!--<div class="col-md-3" id="delete_user"><button type="button" class="btn btn-danger btn-block btn-lg"><i class="fa fa-check-circle"></i>&nbsp;&nbsp;删&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;除</button></div>
                <div class="col-md-3" id="reply_user"><button type="button" class="btn btn-primary btn-block btn-lg"><i class="fa fa-reply"></i>&nbsp;&nbsp;恢&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;复</button></div>  -->
                <div class="col-md-3" id="btnCancel"><button type="button" disabled="disabled" class="btn btn-default btn-block btn-lg"><i class="fa fa-close"></i>&nbsp;&nbsp;取&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;消</button></div>
            </div>
        </form>
    </div>
    
	<script src="<%=basePath%>static/page/user/edit_user.js?v=<%=StaticVersion%>"></script>
  </body>
</html>