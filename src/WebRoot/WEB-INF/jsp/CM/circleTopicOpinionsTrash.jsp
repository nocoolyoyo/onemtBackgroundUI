 			 ...
 			 <div class="col-sm-2">
                <div class="ibox float-e-margins">
             		...
             		<div class="ibox-content">
						<a class="btn btn-block btn-white" href="CMcircleTopicOpinionsAll.shtml?page_id=${paramMap.page_id}">全部</a>
						<a class="btn btn-block btn-primary">垃圾箱</a>	
					</div>
                </div>
            </div>
            <div class="col-sm-10">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
               			<h3>观点管理 &nbsp;&nbsp;&nbsp;<span id="commentTitle" style="display:none"><span class="label-warning"></span>&nbsp;&nbsp;&nbsp;</span><small id="pageSubTitle">观点垃圾箱</small></h3>
                        <!-- <h3>内容管理 > 圈子话题 > 观点管理 > 垃圾箱</h3> -->
                    </div>
		            <div class="ibox-content ">
		                <div id="tableTools">
		                    <%--搜索条件bar  start--%>
...
<!-- 	<div id="translateModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
  ...
  <script src="<%=basePath%>static/page/CM/circleTopicOpinionsTrash.js?v=<%=StaticVersion%>"></script>
</html>
