...
<div class="wrapper wrapper-content animated fadeInRight dashboard-header">
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h3>圈子帮助管理&nbsp;&nbsp;&nbsp;<small id="pageSubTitle">全部帮助列表</small></h3>
        </div>
            ...
            <div id="tableTools">
                ...
                <form class="form-inline bars">
                    <div class="input-group date m-b-xs">
                        <input id="releaseStartTime" class="form-control form_date" size="10" type="text" data-end="#releaseEndTime" value="" placeholder="发布时间-起" readonly />
                        <label for="releaseStartTime" class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></label>
                    </div>
                    <div class="input-group date m-b-xs">
                        <input id="releaseEndTime" class="form-control form_date" size="10" type="text" data-start="#releaseStartTime" value="" placeholder="发布时间-止" readonly />
...
<%--页面css及js文件--%>
<script src="<%=basePath%>static/page/CM/circleHelpAll.js?v=<%=StaticVersion%>"></script>
</body>
</html>