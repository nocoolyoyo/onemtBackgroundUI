...
<html lang="zh_cn">
  ...
  <body class="gray-bg">
					    ...
					    <div id="tableTools">
		                    <form class="form-inline bars">
		                        <div class="input-group m-b-xs">
		                        	<input id="titleKeyword" name="titleKeyword" type="text" class="form-control" placeholder="请输入标题关键字">
		                        </div>
	                            <div class="input-group m-b-xs">
		                        	<input id="circleKeyword" name="circleKeyword" type="text" class="form-control" placeholder="请输入圈子关键字">
		                        </div>
	                            <div class="input-group m-b-xs">
		                       		<input placeholder="开始日期始" readonly class="form-control layer-date" id="startTime" name="startTime">
		                        </div>
                               <div class="input-group m-b-xs">
		                       		<input placeholder="开始日期末" readonly class="form-control layer-date" id="endTime" name="endTime">
		                        </div> 
    ...
    <%--页面css及js文件--%>	
    <script src="<%=basePath%>static/page/CM/circleActivityReleased.js"></script>
</html>
