...
<html lang="zh_cn">
  ...
  <body class="gray-bg">
             		...
             		<div class="ibox-content">
					    <div id="tableTools">
		                    <form class="form-inline bars">
                                ...
                                <div class="input-group m-b-xs">
		                       		<input placeholder="创建日期始" readonly class="form-control layer-date" id="startTime" name="startTime">
		                        </div>
                               <div class="input-group m-b-xs">
		                       		<input placeholder="创建日期末" readonly class="form-control layer-date" id="endTime" name="endTime">
		                        </div> 
    ...
    <%--页面css及js文件--%>	
    <script src="<%=basePath%>static/page/CM/circleActivityDrafts.js"></script>
</html>
