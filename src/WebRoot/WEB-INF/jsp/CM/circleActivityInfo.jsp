        ...
        <div class="ibox float-e-margins">
            <div class="ibox-content col-md-offset-1 col-md-10">
                <div id="divLabelPanel" class="pull-left">
                    <span id="lblState" data-tip="圈子活动发布到信息流中的状态" class="label label-inverse">发布状态加载中...</span>
                    <span id="lblStatus" data-tip="已删除的圈子活动将进入垃圾箱" class="label label-inverse">垃圾箱状态加载中...</span>
                </div>
                ...
                <div class="article-title">
                    ...
                    <div class="m-b-lg text-left">
                        <div class="h2" style="display:inline-block">圈子：<span id="lblExampleCircle" href="javascript:;"></span></div>
                		<hr />
                    </div>
                    <div class="row">
                        <label class="col-sm-2 control-label text-right">开始时间：</label>
	                    <div class="col-xs-10 col-md-9 text-left" id="lblExampleStarttime">
	                    </div>
                    </div>
                    <hr />
                    <div class="row">
                        <label class="col-sm-2 control-label text-right">结束时间：</label>
	                    <div class="col-xs-10 col-md-9 text-left" id="lblExampleEndtime">
	                    </div>
                    </div>
                    <hr />
                    <div class="row">
                        <label class="col-sm-2 control-label text-right">地点：</label>
	                    <div class="col-xs-10 col-md-9 text-left" id="txtPlace">
	                    </div>
                    </div>
                    <hr />
                    <div class="row">
                        <label class="col-sm-2 control-label text-right">详细地址：</label>
	                    <div class="col-xs-10 col-md-9 text-left" id="txtAddress">
	                    </div>
                    </div>
                    <hr />
                    <div class="row">
                        <label class="col-sm-2 control-label text-right">直播地址：</label>
	                    <div class="col-xs-10 col-md-9 text-left" id="lblAddrest">
	                    </div>
                    </div>
                    <hr />
                    <div class="row">
                        <label class="col-sm-2 control-label text-right">嘉宾：</label>
                        <table id="txtRelatedlist" style="margin-left:150px;width: 600px;"></table>
                    </div>
                    <hr />
	                <%--相关链接--%>
	                <div class="row" id="articleLink">
	                    <label class="col-sm-2 control-label text-right">相关报导：</label>
	                ...
	                <%--精彩内容--%>
	                <div class="row" id="articleLink">
	                    <label class="col-sm-2 control-label text-right">精彩内容：</label>
	                    <div class="col-xs-10 col-md-9">
	                        <table id="articleSummary" style="width: 700px;"></table>
	                    </div>
	                </div>
                    <hr />
                    <div class="row">
                        <label class="col-sm-2 control-label text-right">活动介绍：</label>
                    </div>
                    <div class="row">
                    	<div id="txtContent" style="margin-left: 150px;text-align: left;" ></div>
                    </div>
...
<%--     通知组件
    ...
    <%--页面css及js文件--%>
    <script src="<%=basePath%>static/page/CM/circleActivityInfo.js?v=<%=StaticVersion%>"></script>
</body>
</html>