        ...
        <div class="ibox float-e-margins">
            <div class="ibox-content col-md-offset-1 col-md-10">
                <div id="divLabelPanel" class="pull-left">
                    <span id="lblState" data-tip="帖子发布到信息流中的状态" class="label label-inverse">发布状态加载中...</span>
                    <span id="lblStatus" data-tip="已删除的帖子将进入垃圾箱" class="label label-inverse">垃圾箱状态加载中...</span>
                    <span id="lblCircle" data-tip="属于什么圈子" class="label label-inverse">圈子加载中...</span>
                </div>
...
<%--     通知组件
    ...
    <%--页面css及js文件--%>
    <script src="<%=basePath%>static/page/CM/circleShareInfo.js?v=<%=StaticVersion%>"></script>
</body>
</html>