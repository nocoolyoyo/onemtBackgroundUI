...
<html lang="zh_cn">
  ...
  <body class="gray-bg">
             		...
             		<div class="ibox-content">
					    <div id="tableTools">
					         <form class="form-inline bars">
                                 ...
                                 <div class="input-group m-b-xs">
		                       		<input placeholder="创建日期始" readonly class="form-control layer-date" id="createStartTime" name="createStartTime">
		                        </div>
                               <div class="input-group m-b-xs">
		                       		<input placeholder="创建日期末" readonly class="form-control layer-date" id="createEndTime" name="createEndTime">
		                        </div> 
                             	<div class="input-group m-b-xs">
		                       		<input placeholder="删除日期始" readonly class="form-control layer-date" id="delStartTime" name="delStartTime">
		                        </div>
                               <div class="input-group m-b-xs">
		                       		<input placeholder="删除日期末" readonly class="form-control layer-date" id="delEndTime" name="delEndTime">
		                        </div> 
    ...
    <%--页面css及js文件--%>	
	<script src="<%=basePath%>static/page/CM/circleShareTrash.js"></script>
</html>
