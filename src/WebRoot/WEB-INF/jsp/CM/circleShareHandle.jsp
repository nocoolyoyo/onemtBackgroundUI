    ...
    <div class="wrapper wrapper-content animated">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <h3>帖子管理&nbsp;&nbsp;&nbsp;<small id="pageSubTitle">新增/修改帖子</small></h3>
            </div>
                    ...
                    <div id="typLength">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" id="circleselect">
                            	<!-- <input id="circles" name="circles" onclick="" type="text" readonly placeholder="点击选择" class="form-control"> -->
                            </div>
                        </div>
                        <div class="form-group">
...
<%--     富文本编辑器组件summernote
    ...
    <%--页面css及js文件--%>
    <script src="<%=basePath%>static/page/CM/circleShareHandle.js?v=<%=StaticVersion%>"></script>
</body>
</html>
