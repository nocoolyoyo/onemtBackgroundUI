  ...
  <body>
    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
             <h3>角色管理&nbsp;&nbsp;&nbsp;<small id="pageSubTitle">新增角色</small></h3>
        </div>
	        ...
	        <form id="frmAddCiphertext" class="form-horizontal">
                ...
                <div class="form-group">
			      ...
			      <div id="divAction" class="row m-t-lg text-center">
				      <button id="add_user" type="button" class="btn btn-lg btn-info dim m-l"><i class="glyphicon glyphicon-floppy-open"></i>&nbsp;&nbsp;保存角色</button>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
        	...
        	$("#add_user").on('click',function(){
        		...
        		$.ajax({
        			url: '<%=basePath%>admin/role/add_roleinfo.shtml',
        			data: {
        			...
        			success: function(res){
        				console.log(res);
        				if(res.code == 0){
        					//swal({title: "角色添加成功",type: "success"});
        					helper.win.changeQuoto({msg: "操作成功!", relation: "role/index.shtml"});
        				}else if(res.code == 1){
        					swal('角色添加失败',res.errMsg,'error');
        				}
        			},
        			error: function(xhr){
        				console.log(xhr);
