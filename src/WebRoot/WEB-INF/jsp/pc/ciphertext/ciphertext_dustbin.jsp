...
<body class="gray-bg">
                ...
                <div id="tableTools">
                    ...
                    <form class="form-inline bars">
                        <div class="input-group m-b-xs">
                            <select id="islength" class="form-control">
                        ...
                        <div class="input-group date m-b-xs">
                            <input id="startcreatetime" class="form-control form_date" size="10" type="text" data-end="#endTime" value="" placeholder="创建日期开始" readonly />
                            <label for="startTime" class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></label>
                        </div>
                        <div class="input-group date m-b-xs">
                            <input id="endcreatetime" class="form-control form_date" size="10" type="text" data-start="#startTime" value="" placeholder="创建日期结束" readonly />
                            <label for="endTime" class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></label>
                        </div>
                        <div class="input-group date m-b-xs">
                            <input id="startupdatetime" class="form-control form_date" size="10" type="text" data-end="#endTime" value="" placeholder="删除日期开始" readonly />
                            <label for="startTime" class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></label>
                        </div>
                        <div class="input-group date m-b-xs">
                            <input id="endupdatetime" class="form-control form_date" size="10" type="text" data-start="#startTime" value="" placeholder="删除日期结束" readonly />
                            <label for="endTime" class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></label>
                        </div>
                        <div class="input-group m-b-xs">
                            <input id="keywords" type="text" class="form-control" placeholder="请输入搜索关键字" />
                        </div>
    ...
    <script src="<%=basePath%>js/ciphertext/ciphertext_dustbin.js"></script>
</body>
</html>
