...
<body class="gray-bg">
                ...
                <div id="tableTools">
                    ...
                    <form class="form-inline bars">
                        ...
                        <div class="input-group date m-b-xs">
                            <input id="startcreatetime" class="form-control form_date" size="10" type="text" value="" placeholder="开始日期" readonly />
                            <label for="startTime" class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></label>
                        </div>
                        <div class="input-group date m-b-xs">
                            <input id="endcreatetime" class="form-control form_date" size="10" type="text" value="" placeholder="结束日期" readonly />
    ...
    <script src="<%=basePath%>js/ciphertext/ciphertext_wait.js"></script>
</body>
</html>
