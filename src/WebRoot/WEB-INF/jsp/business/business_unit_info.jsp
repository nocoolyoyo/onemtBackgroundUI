        ...
        <div class="ibox float-e-margins">
            <div class="ibox-content col-md-offset-1 col-md-10">
                <div id="divLabelPanel" class="pull-left">
                    <span id="lblStatus" data-tip="已删除的招商单位将进入垃圾箱" class="label label-inverse">垃圾箱状态加载中...</span>
                </div>
                    ...
                    <div class="row">
		                 ...
		                 <div class="col-sm-9">                 
                              <div id="circleAvatar" class="form-avatar-box cursor" style="width:120px;height:120px">
                                 	<img id="unitLogo" style="width:120px;height:120px"  src="<%=basePath%>/img/imageHolder.jpg">
                               </div>
		                 </div>
                    </div>
                    <div class="row">
                        <label class="col-sm-2 control-label text-right">账户名：</label>
	                    <div class="col-xs-10 col-md-9 text-left" id="txtUsername">
	                    </div>
                    </div>
                    <div class="row">
                        <label class="col-sm-2 control-label text-right">单位地址：</label>
	                    <div class="col-xs-10 col-md-9 text-left" id="txtAddress">
	                    </div>
                    </div>
                    <div class="row">
                        <label class="col-sm-2 control-label text-right">联系电话：</label>
	                    <div class="col-xs-10 col-md-9 text-left" id="txtPhone">
	                    </div>
                    </div>
                    <div class="row">
                        <label class="col-sm-2 control-label text-right">单位简介：</label>
                        <div class="col-xs-10 col-md-9 text-left" id="txtProfile">
                    </div>
                </div>
                <%--操作区--%>
...
<%--     通知组件
    ...
    富文本编辑器组件summernote
    <link href="<%=basePath%>static/lib/summernote/summernote.css?v=<%=StaticVersion%>" rel="stylesheet" />
    <script src="<%=basePath%>static/lib/summernote/summernote.min.js?v=<%=StaticVersion%>"></script>
    <script src="<%=basePath%>static/lib/summernote/summernote-zh-CN.js?v=<%=StaticVersion%>"></script>
    查看图片组件
    ...
    <%--页面css及js文件--%>
    <script src="<%=basePath%>static/page/business/business_unit_info.js?v=<%=StaticVersion%>"></script>
</body>
</html>