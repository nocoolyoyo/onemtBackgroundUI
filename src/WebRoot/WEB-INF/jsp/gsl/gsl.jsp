...
<div class="wrapper wrapper-content animated fadeInRight dashboard-header">
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <h3>工商联要闻管理&nbsp;&nbsp;&nbsp;<small id="pageSubTitle">已发布工商联要闻列表</small></h3>
        </div>
...
<%--页面css及js文件--%>
<script src="<%=basePath%>static/page/gsl/gslReleaseList.js?v=<%=StaticVersion%>"></script>
</body>
</html>
